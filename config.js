var config = {
    ...
    projection: 'globe',
    use3dTerrain: false,
    title: '<a href="https://www.crisisgroup.org" target="_blank"><img id="icg" src="images/icg-oj.png" /></a><br /><video id="background-video" autoplay loop muted poster="images/poster.jpg"><source src="images/aerial.mp4" type="video/mp4"></video><h1>Floods, Displacement and Violence in South Sudan</h1><p class="hedp">Stresses brought about by climate change – including record-breaking droughts, floods and heat extremes – are an important driver of internal displacement in the Global South. The impact that displacement in turn has on conflict dynamics is amplified in fragile states, where political instability and poor governance undermine climate resilience, impede humanitarian support and pave the way for communal friction.</p><p class="hedp"><strong>A prime example is South Sudan, reeling from its recent civil war, where four consecutive years of historic flooding have exacerbated food and livelihood insecurity. Rising waters have sent pastoralists fleeing south, where their presence has increased tensions and contributed to violence in the Equatoria region.</p><a id="freeExplore" href="#INTRO"> BEGIN &nbsp;&nbsp; &#8595; </a><p id="vidcredit">Video: © <a href="https://www.unhcr.org/en-us/news/stories/2022/3/6242bef84/south-sudanese-battle-record-floods-amid-rapidly-changing-climate.html" target="_blank">UNHCR</a></p>',
    subtitle: '',
    byline: '',
    ...
    chapters: [
      ...
      },
      {
        ...
        },
        {
            ...
            title: '',
            image: '',
            description: '<div class="padding"><h3 class="white"><span style="background-color: #7e6059; font-size: 24px; font-weight: 600; border-radius: 8px; padding: 5px 10px 5px 10px;">Flood Extent and Internal Displacements in South Sudan</span></h3><p>Since 2019, the country has struggled with historic floods, putting persistent pressures on affected communities, driving internal displacement, overwhelming local coping mechanisms and preventing people from returning to their homes. </p><a href="https://twitter.com/share?url=See%20how%20increased%20flooding%20in%20Africa%20has%20led%20to%20massive%20displacements%20https://southsudan.crisisgroup.org/%23chart03%20via%20@CrisisGroup" target="_blank">Tweet this chart</a></div>' + '<div class="flourish-embed flourish-table" data-src="visualisation/11009243"></div>' + '<br />',
            location: {
              center: [31.691412, 7.078249],
              zoom: 7.01,
              pitch: 42,
        ...
        },
        {
            ...
            image: '',
            description: '<span class="blue">Floods in 2020</span> <strong>were so severe</strong> that waters did not fully recede in the intervening dry seasons. The waterlogged soil worsened the 2021 floods and set the stage for rapid inundation during the rainy season.',
            location: {
        ...
        },
        {
            ...
            image: '',
            description: '<strong>Although annual precipitation usually peaks in August</strong>, water levels rise gradually, with floods reaching their maximum extent in October, particularly in South Sudan’s central regions.',
            location: {
              center: [31.03374, 7.20294],
              zoom: 6,
              pitch: 40.50,
        ...
        },
        {
            ...
            image: '',
            description: '<strong>Unusually, water did not recede in early 2022 in many regions of South Sudan</strong>. Even typically dry months like March saw substantial flooding, which kept some areas inaccessible and prevented the fringes of the wetlands from drying out between flood seasons.',
            location: {
              center: [31.03374, 7.20294],
              zoom: 6,
              pitch: 40.50,
        ...
        },
        {
            ...
            title: '',
            image: '',
            description: '<h2 class="liftout">Crisis Group has tracked <span class="green">herders displaced</span> by South Sudan’s floods who later were involved in <span class="red">violent clashes</span> with their new host communities and insurgents fighting the government.</h2>',
            location: {
              center: [31.03374, 7.20294],
              zoom: 6,
              pitch: 40.50,
        ...
        },
        {
            ...
            title: ' ',
            image: '',
            description: 'On their journey, <strong>Samuel and his group travelled hundreds of miles by foot and boat</strong>, losing cattle to disease and bandits along the way. As they progressed southward toward Bor town, the Jonglei state capital, <strong>deep flood waters forced Samuel’s group to ford the water with their children on their backs and herds in tow</strong>.' + '<div class="spacer"></div>' + 'At night Samuel’s party took refuge on higher ground, relatively protected from flood waters.',
            location: {
        ...
        },
        {
            ...
            image: '',
            description: 'Samuel and his group continued for several more days beyond Juba, finally settling in the bush near other cattle camps in the Kajo Keji and Yei areas south and south west of Juba. The entire journey took nearly two weeks. <strong>They had escaped the floods but now faced new dangers</strong>.',
            location: {
        ...
        },
        {
            ...
            title: ' ',
            image: '',
            description: '<strong>While floods have done much to drive displacement and conflict in South Sudan</strong>, the region is also simultaneously experiencing <a href="https://globalclimate.crisisgroup.org/" target="_blank">other forms of climatic distress</a>.' + '<div class="spacer"></div>' + 'Since 2020, much of the nearby eastern Horn of Africa has endured below-average <span class="rain">rainfall</span> resulting in historic prolonged droughts. This low-rain period comes on top of the 2019 locust outbreak that strained agriculture in the region. Moreover, the spring 2022 rainy season was exceptionally dry and there are elevated chances that the current wet season, which runs through December, will mark the region’s fifth consecutive season of drought. As <a href="https://nigeriaclimate.crisisgroup.org/" target="_blank">Crisis Group has explored elsewhere</a>, water scarcity brings its own conflict risks.' + '<div class="spacer"></div>' + 'Freely explore this map. &#8594;' + '<div class="spacer"></div>' + '<div class="video-container"><iframe src="https://flo.uri.sh/visualisation/11056737/embed" frameborder="0" scrolling="no"></iframe></div>',
            location: {
        ...
        },
        {
            ...
            title: ' ',
            image: '',
            description: 'The effects of climate change today are felt mainly locally, even if their political ramifications sometimes reverberate at the national level, as in South Sudan. As global warming increases, weather and climate extremes are likely to become more severe and frequent – <strong>bringing with them consequences for peace and security at greater scale</strong>.' + '<div class="spacer"></div>' + 'Rich countries responsible for the bulk of historic carbon emissions could do much more to ease the pain.' + '<div class="spacer"></div>' + 'Freely explore this map. &#8594;',
            location: {
              center: [31.73713, 7.21163],
              zoom: 5,
              pitch: 44.00,
        ...
        },
        {
            ...
            image: '',
            description: '<strong>External partners and the UN should work with South Sudanese authorities, religious leaders, community elders and others to de-escalate tensions and create security for both displaced and host communities, while protecting the needs of both</strong>.' + '<div class="spacer"></div>' + '<strong>Authorities should try to ease political tensions between the displaced and host communities</strong>, such as by organising a conference of Jonglei and Equatorian leaders to agree on basic modalities in the likely event of future displacement, including potential migration corridors, grazing land, timetables for returns, protections for farmers and host communities, and adjudication mechanisms. Though this dialogue will be contentious given the heated politics, the alternative is worsening violence as climate-driven risk factors continue to increase tensions. External partners can support such processes or fill in gaps should the authorities not take up the task. ' + '<div class="spacer"></div>' + '<img src="images/sam_poster.jpg" />' + '<div class="spacer"></div>' + 'Aid groups should pre-position assistance for the displaced and help them return home. In addition to honouring their commitments to provide climate adaptation funding, donor countries should offer technical experts to work with national and local South Sudanese authorities. These experts could work on helping communities to mitigate the flooding’s harm while protecting the ecosystems preserving traditional livelihoods that rely on seasonal floods. Donor countries should then offer to fund these flood-mitigation strategies, while taking care that the funds do not simply disappear amid the <a href="https://www.crisisgroup.org/africa/horn-africa/south-sudan/305-oil-or-nothing-dealing-south-sudans-bleeding-finances" target="_blank">extreme corruption</a> that characterises South Sudan’s young state.' + '<div class="spacer"></div>' + 'Finally, even while addressing the climate-driven risks described above, <strong>outside stakeholders should not lose sight of the broader political context</strong>, which remains fraught. <a href="https://www.crisisgroup.org/africa/horn-africa/south-sudan/b169-south-sudans-other-war-resolving-insurgency-equatoria" target="_blank">They should refocus</a> their attention on resolving the conflict in the Equatoria region, including by resuscitating the stalled peace talks in Rome between the South Sudanese government and the Equatoria-based National Salvation Front insurgency.' + '<div class="spacer"></div>' + '<strong>Read more of Crisis Group’s work on climate, environment and conflict <a href="https://www.crisisgroup.org/future-conflict/climate-environment-and-conflict" target="_blank">here</a></strong>.',
            location: {
              center: [31.73713, 7.21163],
              zoom: 5,
              pitch: 44.00,
