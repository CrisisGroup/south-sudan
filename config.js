    ...
    chapters: [
      ...
      },
      {
        ...
        },
        {
            ...
            image: '',
            description: 'Floods in 2020 were so severe that waters did not fully recede in the intervening dry seasons. The waterlogged soil worsened the 2021 floods and set the stage for rapid inundation during the rainy season.',
            location: {
        ...
        },
        {
            ...
            image: '',
            description: 'Unusually, water did not recede in early 2022 in many regions of South Sudan. Even typically dry months like March saw substantial flooding, which kept some areas inaccessible and prevented the fringes of the wetlands from drying out between flood seasons.',
            location: {
              center: [31.03374, 7.20294],
              zoom: 6,
              pitch: 40.50,
