    ...
    chapters: [
      ...
      },
      {
        ...
        },
        {
            ...
            title: ' ',
            image: '',
            description: 'While floods have done much to drive displacement and conflict in South Sudan, the region is also simultaneously experiencing other forms of climatic distress.' + '<div class="spacer"></div>' + 'Since 2020, much of the nearby eastern Horn of Africa has endured below-average rainfall  resulting in historic prolonged droughts. This low-rain period comes on top of the 2019 locust outbreak that strained agriculture in the region. Moreover, the spring 2022 rainy season was exceptionally dry and there are elevated chances that the current wet season, which runs through December, will mark the region’s fifth consecutive season of drought. As <a href="https://nigeriaclimate.crisisgroup.org/" target="_blank">Crisis Group has explored elsewhere</a>, water scarcity brings its own conflict risks.' + '<div class="spacer"></div>' + '<div class="video-container"><iframe src="https://flo.uri.sh/visualisation/11056737/embed" frameborder="0" scrolling="no"></iframe></div>',
            location: {
